...
export const metadata: Metadata = {
  title: "Products & Pricing | safzzo — Enterprise Software Salem Tamil Nadu",
  description:
    "Explore safzzo products: Enterprise ERP, CRM, Analytics Suite, and Cloud Platform. Transparent pricing starting ₹999/month. Built in Salem, Tamil Nadu for Indian businesses.",
  keywords: [
    "SaaS pricing India",
